...
ChuckGroup:
	...
	db 54, TAUROS,     PINK_BOW,      THRASH, ROCK_SMASH, CURSE, PURSUIT
...
ClairGroup:
	...
	; CLAIR (2): Rematch
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 53, GYARADOS,   FOCUS_BAND,      CRUNCH, SURF, FLY, TWISTER
...
WillGroup:
	...
	db "WILL@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		db 66, MR__MIME
			...
			db GOLD_BERRY
			db MEDITATE, SUBSTITUTE, BATON_PASS, PSYCHIC_M
		db 67, ESPEON
			dw $FE01, $FE01, $FE01, $FE01, $FE01 ; hp, atk, def, spd, spc
			db SPELL_TAG
...
BrunoGroup:
	...
	db "BRUNO@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		...
		db 67, TAUROS
			dw $BE80, $BE80, $BE80, $BE80, $BE80 ; hp, atk, def, spd, spc
			db FOCUS_BAND
			db STRENGTH, REVERSAL, EARTHQUAKE, ENDURE
		db 68, MACHAMP
			dw $7F00, $7F00, $7F00, $7F00, $7F00 ; hp, atk, def, spd, spc
			db LEFTOVERS
...
; KAREN (2) Rematch
	db "KAREN@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		...
		db 67, MISDREAVUS
			dw $FE01, $FE01, $FE01, $FE01, $FE01 ; hp, atk, def, spd, spc
			db SPELL_TAG
			db SHADOW_BALL, MOONBLAST, HYPNOSIS, DREAM_EATER
		db 69, HOUNDOOM
			dw $7F00, $7F00, $7F00, $7F00, $7F00 ; hp, atk, def, spd, spc
			db BLACKGLASSES
...
ChampionGroup:
	...
	db "LANCE@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		db 69, GYARADOS
			dw $FE01, $FE01, $FE01, $FE01, $FE01 ; hp, atk, def, spd, spc
			db LEFTOVERS
			db SURF, RAIN_DANCE, HYPER_BEAM, CRUNCH
		db 68, DRAGONITE
			dw $BE80, $BE80, $BE80, $BE80, $BE80 ; hp, atk, def, spd, spc
			db MIRACLEBERRY
...
ErikaGroup:
	...
	db 61, VENUSAUR,   LEFTOVERS,       SUNNY_DAY, SOLARBEAM, EARTHQUAKE, SLEEP_POWDER
	db 62, VICTREEBEL, POISON_BARB,     SLUDGE_BOMB, GIGA_DRAIN, SWORDS_DANCE, SLEEP_POWDER
	db 62, BELLOSSOM,  MIRACLE_SEED,    SUNNY_DAY, SYNTHESIS, SLEEP_POWDER, MOONBLAST
	db -1 ; end
...
BlueFinalGroup:
	...
	db "BLUE@", TRAINERTYPE_HAPPINESS | TRAINERTYPE_ITEM_MOVES
		...
		db 73, SCIZOR
			db 255
			db SCOPE_LENS
			db AGILITY, BATON_PASS, CUT, METAL_CLAW
		db 74, BLASTOISE
			db 255
			db MYSTIC_WATER
