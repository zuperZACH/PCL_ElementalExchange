...
WillGroup:
	...
	db "WILL@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		db 66, MR__MIME
			...
			db GOLD_BERRY
			db MEDITATE, SUBSTITUTE, PSYCHIC_M, BATON_PASS
		db 67, ESPEON
			dw $FE01, $FE01, $FE01, $FE01, $FE01 ; hp, atk, def, spd, spc
			db SPELL_TAG
...
RedGroup:
	...
	db 77, BLASTOISE,  QUICK_CLAW,     ICE_BEAM, HYDRO_PUMP, IRON_TAIL, EARTHQUAKE
...
BlueFinalGroup:
	...
	db "BLUE@", TRAINERTYPE_HAPPINESS | TRAINERTYPE_ITEM_MOVES
		...
		db 73, ALAKAZAM
			db 255
			db FOCUS_BAND
			db PSYCHIC_M, THUNDER_WAVE, SHADOW_BALL, RECOVER
		db 73, NINETALES
			db 255
			db MINT_BERRY
